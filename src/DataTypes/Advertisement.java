...
public class Advertisement implements Serializable {
    ...
    public Advertisement(String name, String description, double price, String city, String location, String phone, long lastUpdate,String[] pics,  boolean isPrioritized) {
        this.name = name;
        this.pics = pics;
        this.price = price;
    ...
    public void printDetails (){
        ...
        LocalDateTime triggerTime =
                LocalDateTime.ofInstant(Instant.ofEpochMilli(lastUpdate),
